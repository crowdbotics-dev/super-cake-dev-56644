"""
Django settings for super_cake_dev_56644 project.
...
ROOT_URLCONF = 'super_cake_dev_56644.urls'
...
WSGI_APPLICATION = 'super_cake_dev_56644.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_cake_dev_56644 API",
    "DESCRIPTION": "API documentation for super_cake_dev_56644 App",
    "VERSION": "v1",
}
